<?php
 ...
 if(mysqli_connect_errno()){
    ...
    $insertuserquery = "INSERT INTO players (username,salt,hash,money_km,latitude,longitude,total_km,current_level,current_task,role) VALUES ('" . $username . "' , '" . $salt . "', '" . $hash . "','1000','0','0','0',1,1,0);";
